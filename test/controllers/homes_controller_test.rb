...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { content: @home.content, tag: @home.tag, writeDate: @home.writeDate }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { content: @home.content, tag: @home.tag, writeDate: @home.writeDate }
    assert_redirected_to home_path(assigns(:home))
  end
